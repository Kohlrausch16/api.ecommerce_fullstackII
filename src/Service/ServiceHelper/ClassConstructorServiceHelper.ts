...
class ClassConstructorServiceHelper{
    ...
    private clientUserPermissions = "get-client-by-id, add-client, put-client, delete-client, get-cart-by-id, get-cart-item-by-id, add-cart-item, put-cart-item, delete-cart-item, get-products, get-product-by-id";
